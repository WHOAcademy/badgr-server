...
mysql.sandbox.svc.cluster.local

To get your root password run:

    MYSQL_ROOT_PASSWORD=$(kubectl get secret --namespace sandbox mysql -o jsonpath="{.data.mysql-root-password}" | base64 --decode; echo)
...
helm install badgr-server \
  --set mysqlRootPassword=secretpassword,mysqlUser=my-user,mysqlPassword=my-password,mysqlDatabase=badgr \
    ./chart