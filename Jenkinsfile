    ...
    stages {
        ...
        stage("Build (Compile App)") {
            ...
            steps {
                ...
                sh 'printenv'
                sh '''
                mv .docker/Dockerfile.openshift.test.api .docker/openshift_deployment .docker/etc .
                tar -zcvf ${PACKAGE} --transform='flags=r;s|Dockerfile.openshift.test.api|Dockerfile|' openshift_deployment/ etc/settings_local.prod.py waf/ apps/ requirements.txt manage.py Dockerfile.openshift.test.api
