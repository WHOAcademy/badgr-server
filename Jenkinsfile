    ...
    stages {
        ...
        stage("Build (Compile App)") {
            ...
            steps {
                ...
                sh 'printenv'
                sh '''
                tar -zcvf ${PACKAGE} --transform='flags=r;s|Dockerfile.openshift.test.api|Dockerfile|' --directory=waf/ apps/ requirements.txt .docker manage.py Dockerfile.openshift.test.api
