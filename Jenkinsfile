    ...
    stages {
        ...
        stage("Build (Compile App)") {
            ...
            steps {
                ...
                sh 'printenv'
                sh '''
                tar -zcvf ${PACKAGE} --transform='flags=r;s|Dockerfile.openshift.test.api|Dockerfile|' .dockerfile/Dockerfile.openshift.test.api waf/ apps/ requirements.txt manage.py
